...
max_training_examples = 5000 #limit the number of training examples used
...
batch_size = 950 #number of examples to pass into the network/use to compute gradient of the loss function
num_epoch = 5 #how many times to backpropogate and update weights
...
num_filter = 2 #number of each filter size
recurrent_state_size = 2 #number of hidden units for each unrolled recurrent layer
recurrent_skip_state_size = 2  # number of hidden units for each unrolled recurrent layer
optimizer = 'Adam'
